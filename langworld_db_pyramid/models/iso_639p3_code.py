...
class Iso639P3Code(Base):  # type: ignore[misc]
    ...
    # doculect corresponds to many ISO-639-3 codes, but that one ISO-639-3 corresponds to many
    # doculects.
    doculects = relationship(
        "Doculect", back_populates="iso_639p3_codes", secondary="doculect_to_iso_639p3_code"
    )
