...
def setup_models(dbsession):
    ...
    # replace with constant path to file:
    encyclopedia_rows = read_csv(ASSETS_DIR / 'encyclopedia_volumes.csv', read_as='dicts')
