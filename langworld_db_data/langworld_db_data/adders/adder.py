...
class Adder:
    def __init__(
        ...
        *,
        ...
        # In a default scenario, these paths will be the same, meaning the file will be updated in
        # place.
        ...
        self.input_feature_profiles = sorted(input_dir_with_feature_profiles.glob("*.csv"))
